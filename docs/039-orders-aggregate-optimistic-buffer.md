...
This note records the decision behind **orders** behavior in react-foundations.
...
Use a small, independently testable function for the optimistic path. Keep input normalization at the boundary and return a neutral value for missing samples.
...
Review marker: decision 39 in the project evolution.

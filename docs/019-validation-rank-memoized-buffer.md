...
This note records the decision behind **validation** behavior in react-foundations.
...
Use a small, independently testable function for the memoized path. Keep input normalization at the boundary and return a neutral value for missing samples.
...
Review marker: decision 19 in the project evolution.

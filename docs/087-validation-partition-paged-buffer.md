...
Use a small, independently testable function for the paged path. Keep input normalization at the boundary and return a neutral value for missing samples.
...
Review marker: decision 87 in the project evolution.

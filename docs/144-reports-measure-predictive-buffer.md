...
This note records the decision behind **reports** behavior in react-foundations.
...
Use a small, independently testable function for the predictive path. Keep input normalization at the boundary and return a neutral value for missing samples.
...
Review marker: decision 144 in the project evolution.
